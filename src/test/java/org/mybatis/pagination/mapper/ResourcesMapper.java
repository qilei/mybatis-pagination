...
//    PageMyBatis<Resources> selectByPageOrder(PagingCriteria pagingCriteria);
    PageMyBatis<Resources> selectByPageOrder(ResourcesPageCriteria pagingCriteria);
//    PageMyBatis<Resources> selectByPageOrderAndWhere(PagingCriteria pagingCriteria,@Param("name") String name);
//    PageMyBatis<Resources> selectByPageOrderAndWhere(PagingCriteria pagingCriteria,MyObj obj);
    PageMyBatis<Resources> selectByPageOrderAndWhere(ResourcesPageCriteria pageCriteria);
}