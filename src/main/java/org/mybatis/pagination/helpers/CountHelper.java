...
//            parameterObject = pa
            ...
            for (int i = 0; i < parameterMappings.size(); i++) {
                ...
                if (parameterMapping.getMode() != ParameterMode.OUT) {
                    ...
                    } /*else if(parameterObject instanceof PagingCriteria){
                        PagingCriteria pagingCriteria = (PagingCriteria) parameterObject;
                        for(SearchField field : pagingCriteria.getSearchFields()) {
                            if (field.getField().equals(propertyName)) {
